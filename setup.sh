#!/bin/bash
# Tamplate Setup Script for Linux/macOS
# This script automates the setup process for the Tamplate application
...
# Navigate to Tamplate.Domain and add migration
echo "[2/3] Creating database migration..."
cd Tamplate.Domain || exit 1
